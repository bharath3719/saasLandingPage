...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Fis_QJg04R--/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__ue5Yp)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___3Fa)}
              role={"img"}
            />
          ),
