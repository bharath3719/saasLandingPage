...
import sty from "./PlasmicFooterSection.module.css"; // plasmic-import: CeyhfwEGeRg3/css

import FacebookSvgIcon from "./icons/PlasmicIcon__FacebookSvg"; // plasmic-import: SfghQv7FcTT6/icon
import TwitterSvgIcon from "./icons/PlasmicIcon__TwitterSvg"; // plasmic-import: jRwwBthmmqhH/icon
import InstagramSvgIcon from "./icons/PlasmicIcon__InstagramSvg"; // plasmic-import: gY-qg1dQ_n5S/icon
import LinkedinSvgIcon from "./icons/PlasmicIcon__LinkedinSvg"; // plasmic-import: 9Adjy3wpvXSN/icon
...
function PlasmicFooterSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__bvk5J)}>
        <div className={classNames(projectcss.all, sty.freeBox__azCyT)}>
          <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.freeBox__hczo8)}>
            <FacebookSvgIcon
              className={classNames(projectcss.all, sty.svg__busx1)}
              role={"img"}
            />

            <TwitterSvgIcon
              className={classNames(projectcss.all, sty.svg__lbOxn)}
              role={"img"}
            />

            <InstagramSvgIcon
              className={classNames(projectcss.all, sty.svg__oqwLd)}
              role={"img"}
            />

            <LinkedinSvgIcon
              className={classNames(projectcss.all, sty.svg__zrH5J)}
              role={"img"}
            />
          </div>
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__uxhS3)}>
          <h4
            className={classNames(
              projectcss.all,
              projectcss.h4,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xajn0)}>
          <h4
            className={classNames(
              projectcss.all,
              projectcss.h4,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__yxkgN)}>
          <h4
            className={classNames(
              projectcss.all,
              projectcss.h4,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pwGzw)}>
        <div
          className={classNames(
            projectcss.all,
            projectcss.__wab_text,
